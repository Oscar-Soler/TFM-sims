...
contains
  ...
  subroutine rm1d_init_one_grid(ixGmin1,ixGmax1,ixmin1,ixmax1,w,x)
    ...
    double precision :: rho_0, v_0, v_0x, v_0y, p_0, b_0, b_0x, b_0y, M0_ms,&
        cs_0, csA_0, cms_0 
...
! is parallel to magnetic field
    ...
    p_1 = p_0 * (x_value + (mhd_gamma-1)*x_value*v_0**2/(2*cs_0**2)*(1-&
       v_1**2/v_0**2))
