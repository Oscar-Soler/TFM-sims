...
!!!cancellation
  ...
  ! calculate background heating bQ
    ...
    ! end where
      ...
      bQgridspecial1(ixO^S)!+bQgridleft(ixO^S)+bQgridright(ixO^S)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      lQgrid(ixO^S)=lQ0*( impulsiveheatingfactor*dexp(-(x(ixO^S,1)-xcenter1)**2/sigma_heating**2)+&
        1.d0*dexp(-(x(ixO^S,1)-xcenter2)**2/sigma_heating**2) )
