...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      lQgrid(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=lQ0*((impulsiveheatingfactor-&
         1.d0)*dexp(-(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         1)-xcenter1)**2/sigma_heating**2)+0.d0*dexp(-(x(ixOmin1:ixOmax1,&
  ...
  subroutine set_output_vars(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
     ixOmax1,ixOmax2,qt,w,x)
      ...
      do idir=1,ndir
         if(B0field) then
            Btotal(ixImin1:ixImax1,ixImin2:ixImax2,idir)=w(ixImin1:ixImax1,&
               ixImin2:ixImax2,mag(idir))+block%B0(ixImin1:ixImax1,&
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,bt_(1)) = Btotal(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,1)
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,bt_(2)) = Btotal(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,2)
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,bt_(3)) = Btotal(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,3)
